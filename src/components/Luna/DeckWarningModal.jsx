...
const DeckWarningModal = ({ isOpen, onClose, onConfirm, onSwitch }) => {
        ...
        >
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-white">Deck Mismatch</h2>
              <p className="text-slate-400">
                Luna senses that this deck may not be ideal for your question.
              </p>
            </div>
